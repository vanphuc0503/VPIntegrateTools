...
/**
 * Precompiled my-java-library script plugin.
 **/
public class MyJavaLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_MyJavaLibrary").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("my-java-base");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MyJavaLibrary").asSubclass(BasicScript.class);
